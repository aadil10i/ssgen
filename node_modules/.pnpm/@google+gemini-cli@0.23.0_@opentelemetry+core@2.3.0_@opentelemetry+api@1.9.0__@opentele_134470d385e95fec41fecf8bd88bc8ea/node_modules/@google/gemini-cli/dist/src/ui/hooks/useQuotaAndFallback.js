 ...
 */
import { AuthType, TerminalQuotaError, ModelNotFoundError, PREVIEW_GEMINI_MODEL, DEFAULT_GEMINI_MODEL, VALID_GEMINI_MODELS, } from '@google/gemini-cli-core';
...
export function useQuotaAndFallback({ config, historyManager, userTier, setModelSwitchedFromQuotaError, }) {
    ...
    useEffect(() => {
        const fallbackHandler = async (failedModel, fallbackModel, error) => {
            ...
            const usageLimitReachedModel = failedModel === DEFAULT_GEMINI_MODEL ||
