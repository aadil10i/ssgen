...
declare const SETTINGS_SCHEMA: {
    ...
    readonly experimental: {
        ...
        readonly properties: {
            ...
            readonly introspectionAgentSettings: {
                readonly type: "object";
                readonly label: "Introspection Agent Settings";
                readonly category: "Experimental";
                readonly requiresRestart: true;
                readonly default: {};
                readonly description: "Configuration for Introspection Agent.";
                readonly showInDialog: false;
                readonly properties: {
                    readonly enabled: {
                        readonly type: "boolean";
                        readonly label: "Enable Introspection Agent";
                        readonly category: "Experimental";
                        readonly requiresRestart: true;
                        readonly default: false;
                        readonly description: "Enable the Introspection Agent.";
                        readonly showInDialog: true;
                    };
                };
            };
