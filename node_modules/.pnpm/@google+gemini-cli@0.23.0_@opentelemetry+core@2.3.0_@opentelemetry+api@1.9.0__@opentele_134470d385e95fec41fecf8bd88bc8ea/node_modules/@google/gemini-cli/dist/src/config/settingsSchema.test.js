...
describe('SettingsSchema', () => {
    describe('getSettingsSchema', () => {
        ...
        it('should have enableAgents setting in schema', () => {
            ...
            expect(setting.description).toBe('Enable local and remote subagents. Warning: Experimental feature, uses YOLO mode for subagents');
        });
        it('should have name and description in hook definitions', () => {
            ...
            const hookItemProperties = hookDef.items.properties.hooks.items
                .properties;
