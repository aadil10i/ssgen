...
import { DiscoveredMCPTool, getMCPDiscoveryState, getMCPServerStatus, MCPDiscoveryState, MCPServerStatus, getErrorMessage, MCPOAuthTokenStorage, mcpServerRequiresOAuth, } from '@google/gemini-cli-core';
...
const authCommand = {
    ...
    action: async (context, args) => {
        ...
        try {
            ...
            await authProvider.authenticate(serverName, oauthConfig, mcpServerUrl, appEvents);
            context.ui.addItem({
                type: 'info',
