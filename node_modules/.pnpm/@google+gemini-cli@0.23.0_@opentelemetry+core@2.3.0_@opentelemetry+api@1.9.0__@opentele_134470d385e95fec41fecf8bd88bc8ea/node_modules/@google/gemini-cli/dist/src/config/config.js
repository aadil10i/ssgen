...
export async function loadCliConfig(settings, sessionId, argv, cwd = process.cwd()) {
    ...
    if (!experimentalJitContext) {
        ...
        const result = await loadServerHierarchicalMemory(cwd, [], debugMode, fileService, extensionManager, trustedFolder, memoryImportFormat, memoryFileFiltering, settings.context?.discoveryMaxDirs);
