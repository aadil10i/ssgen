...
describe('hooksCommand', () => {
    ...
    describe('enable subcommand', () => {
        ...
        it('should enable a hook and update settings', async () => {
            ...
            const result = await enableCmd.action(mockContext, 'test-hook');
            expect(mockContext.services.settings.setValue).toHaveBeenCalledWith(expect.any(String), 'hooks.disabled', ['other-hook']);
        ...
        it('should complete hook names using friendly names', () => {
            const enableCmd = hooksCommand.subCommands.find((cmd) => cmd.name === 'enable');
            const hookEntry = createMockHook('./hooks/test.sh', HookEventName.BeforeTool, true);
    ...
    describe('disable subcommand', () => {
        it('should return error when config is not loaded', async () => {
            ...
            const disableCmd = hooksCommand.subCommands.find((cmd) => cmd.name === 'disable');
        ...
        it('should disable a hook and update settings', async () => {
            ...
            const result = await disableCmd.action(mockContext, 'test-hook');
            expect(mockContext.services.settings.setValue).toHaveBeenCalledWith(expect.any(String), 'hooks.disabled', ['test-hook']);
 ...
 */
function createMockHook(command, eventName, enabled) {
    return {
        config: {
            command,
...
//# sourceMappingURL=hooksCommand.test.js.map