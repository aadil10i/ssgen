...
vi.mock('../core/client.js', () => ({
    GeminiClient: vi.fn().mockImplementation(function (_config) {
        this.startChat = (...params) => mockStartChat(...params);
        this.sendMessageStream = (...params) => mockSendMessageStream(...params);
        return this;
    }),
}));
// END MOCKS
...
describe('editCorrector', () => {
    ...
    describe('ensureCorrectEdit', () => {
        ...
        describe('Scenario Group 1: originalParams.old_string matches currentContent directly', () => {
            it('Test 1.1: old_string (no literal \\), new_string (escaped by Gemini) -> new_string unescaped', async () => {
                ...
                const result = await ensureCorrectEdit('/test/file.txt', currentContent, originalParams, mockGeminiClientInstance, mockBaseLlmClientInstance, abortSignal);
        ...
        describe('Scenario Group 6: Concurrent Edits', () => {
            it('Test 6.1: should return early if file was modified by another process', async () => {
                ...
                mockGeminiClientInstance.getHistory.mockReturnValue(history);
                const result = await ensureCorrectEdit(filePath, currentContent, originalParams, mockGeminiClientInstance, mockBaseLlmClientInstance, abortSignal);
                expect(result.occurrences).toBe(0);
                expect(result.params).toEqual(originalParams);
            });
        });
    ...
    describe('ensureCorrectFileContent', () => {
        ...
        it('should return content unchanged if no escaping issues detected', async () => {
            ...
            const result = await ensureCorrectFileContent(content, mockBaseLlmClientInstance, abortSignal);
