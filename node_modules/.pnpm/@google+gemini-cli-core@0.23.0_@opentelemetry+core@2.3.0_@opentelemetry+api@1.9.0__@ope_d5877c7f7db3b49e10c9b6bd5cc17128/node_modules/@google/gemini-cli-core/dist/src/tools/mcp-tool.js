...
class DiscoveredMCPToolInvocation extends BaseToolInvocation {
    ...
    constructor(mcpTool, serverName, serverToolName, displayName, trust, params = {}, cliConfig, messageBus) {
...
export class DiscoveredMCPTool extends BaseDeclarativeTool {
    ...
    constructor(mcpTool, serverName, serverToolName, description, parameterSchema, trust, nameOverride, cliConfig, extensionName, extensionId, messageBus) {
        ...
        messageBus, extensionName, extensionId);
        this.mcpTool = mcpTool;
        this.serverName = serverName;
        this.serverToolName = serverToolName;
    ...
    asFullyQualifiedTool() {
        return new DiscoveredMCPTool(this.mcpTool, this.serverName, this.serverToolName, this.description, this.parameterSchema, this.trust, `${this.getFullyQualifiedPrefix()}${this.serverToolName}`, this.cliConfig, this.extensionName, this.extensionId, this.messageBus);
    }
