...
describe('HookPlanner', () => {
    ...
    describe('createExecutionPlan', () => {
        ...
        it('should filter hooks by regex matcher', () => {
            ...
            const editPlan = hookPlanner.createExecutionPlan(HookEventName.BeforeTool, { toolName: 'EditTool' });
            ...
            const writePlan = hookPlanner.createExecutionPlan(HookEventName.BeforeTool, { toolName: 'WriteTool' });
            ...
            const readPlan = hookPlanner.createExecutionPlan(HookEventName.BeforeTool, { toolName: 'ReadTool' });
            ...
            const otherPlan = hookPlanner.createExecutionPlan(HookEventName.BeforeTool, { toolName: 'OtherTool' });
        ...
        it('should deduplicate identical hooks', () => {
            ...
            expect(mockDebugLogger.debug).toHaveBeenCalledWith(expect.stringContaining('Deduplicated hook'));
        });
        ...
        it('should match trigger for session events', () => {
            ...
            const startupPlan = hookPlanner.createExecutionPlan(HookEventName.SessionStart, { trigger: 'startup' });
            ...
            // Test resume trigger
            const resumePlan = hookPlanner.createExecutionPlan(HookEventName.SessionStart, { trigger: 'resume' });
...
//# sourceMappingURL=hookPlanner.test.js.map