 ...
 */
export function getEffectiveModel(requestedModel, previewFeaturesEnabled) {
    return resolveModel(requestedModel, previewFeaturesEnabled);
}
export function getDisplayString(model, previewFeaturesEnabled = false) {
    switch (model) {
        ...
        case GEMINI_MODEL_ALIAS_PRO:
            return `Manual (${previewFeaturesEnabled ? PREVIEW_GEMINI_MODEL : DEFAULT_GEMINI_MODEL})`;
        case GEMINI_MODEL_ALIAS_FLASH:
            return `Manual (${previewFeaturesEnabled
                ? PREVIEW_GEMINI_FLASH_MODEL
                : DEFAULT_GEMINI_FLASH_MODEL})`;
        default:
            return `Manual (${model})`;
