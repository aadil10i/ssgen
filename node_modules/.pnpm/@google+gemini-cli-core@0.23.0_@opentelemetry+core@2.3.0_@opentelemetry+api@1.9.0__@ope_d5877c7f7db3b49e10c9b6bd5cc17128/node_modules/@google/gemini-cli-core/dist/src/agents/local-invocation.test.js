...
describe('LocalSubagentInvocation', () => {
    ...
    describe('getDescription', () => {
        it('should format the description with inputs', () => {
            ...
            const invocation = new LocalSubagentInvocation(testDefinition, mockConfig, params);
        ...
        it('should truncate the overall description if it exceeds the limit', () => {
            ...
            const invocation = new LocalSubagentInvocation(longNameDef, mockConfig, params);
            const description = invocation.getDescription();
    ...
    describe('execute', () => {
        ...
        beforeEach(() => {
            ...
            updateOutput = vi.fn();
            invocation = new LocalSubagentInvocation(testDefinition, mockConfig, params);
        });
...
//# sourceMappingURL=local-invocation.test.js.map