    ...
    describe('alias inheritance', () => {
        ...
        describe('abstract aliases', () => {
            ...
            it('should throw an error if a resolved alias chain has no model', () => {
                ...
                const service = new ModelConfigService(config);
                expect(() => service.getResolvedConfig({ model: 'abstract-base' })).toThrow('Could not resolve a model name for alias "abstract-base". Please ensure the alias chain or a matching override specifies a model.');
            });
...
//# sourceMappingURL=modelConfigService.test.js.map