...
import { getCommandRoots, initializeShellParsers, stripShellWrapper, } from '../utils/shell-utils.js';
...
export class ShellToolInvocation extends BaseToolInvocation {
    config;
    allowlist;
    constructor(config, params, allowlist, messageBus, _toolName, _toolDisplayName) {
...
export class ShellTool extends BaseDeclarativeTool {
    ...
    createInvocation(params, messageBus, _toolName, _toolDisplayName) {
        return new ShellToolInvocation(this.config, params, this.allowlist, messageBus, _toolName, _toolDisplayName);
    }
}
