...
import { getResponseTextFromParts, getFunctionCalls, getFunctionCallsFromParts, getFunctionCallsAsJson, getFunctionCallsFromPartsAsJson, getStructuredResponse, getStructuredResponseFromParts, getCitations, } from './generateContentResponseUtilities.js';
import { FinishReason } from '@google/genai';
const mockTextPart = (text) => ({ text });
const mockFunctionCallPart = (name, args) => ({
    functionCall: { name, args: args ?? {} },
});
const mockResponse = (parts, finishReason = FinishReason.STOP, safetyRatings = [], citationMetadata) => ({
    candidates: [
        {
            content: {
                parts,
