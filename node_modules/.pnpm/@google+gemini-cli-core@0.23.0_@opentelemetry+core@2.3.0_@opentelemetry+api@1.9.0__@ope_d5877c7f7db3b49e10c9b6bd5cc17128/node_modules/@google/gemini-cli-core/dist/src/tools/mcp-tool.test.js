...
describe('DiscoveredMCPTool', () => {
    ...
    describe('execute', () => {
        ...
        describe('AbortSignal support', () => {
            ...
            it('should abort immediately if signal is already aborted', async () => {
                ...
                controller.abort();
                const invocation = tool.build(params);
                await expect(invocation.execute(controller.signal)).rejects.toThrow('Tool call aborted');
    ...
    describe('shouldConfirmExecute', () => {
        it('should return false if trust is true', async () => {
            const trustedTool = new DiscoveredMCPTool(mockCallableToolInstance, serverName, serverToolName, baseDescription, inputSchema, true, undefined, { isTrustedFolder: () => true });
