...
const createMCPTool = (serverName, toolName, description, mockCallable = {}) => new DiscoveredMCPTool(mockCallable, serverName, toolName, description, {});
...
describe('ToolRegistry', () => {
    ...
    describe('sortTools', () => {
        it('should sort tools by priority: built-in, discovered, then MCP (by server name)', () => {
            ...
            const discovered1 = new DiscoveredTool(config, 'discovered-1', DISCOVERED_TOOL_PREFIX + 'discovered-1', 'desc', {});
    ...
    describe('DiscoveredToolInvocation', () => {
        it('should return the stringified params from getDescription', () => {
            const tool = new DiscoveredTool(config, 'test-tool', DISCOVERED_TOOL_PREFIX + 'test-tool', 'A test tool', {});
