...
import { DEFAULT_TRUNCATE_TOOL_OUTPUT_LINES, DEFAULT_TRUNCATE_TOOL_OUTPUT_THRESHOLD, ToolErrorType, ApprovalMode, HookSystem, PREVIEW_GEMINI_MODEL, } from '../index.js';
...
describe('executeToolCall', () => {
    ...
    it('should execute a tool successfully', async () => {
        ...
        expect(response).toStrictEqual({
            ...
            contentLength: typeof toolResult.llmContent === 'string'
    ...
    it('should calculate contentLength for a string llmContent', async () => {
        ...
        executeFn.mockResolvedValue(toolResult);
        const { response } = await executeToolCall(mockConfig, request, abortController.signal);
        expect(response.contentLength).toBe(typeof toolResult.llmContent === 'string'
            ? toolResult.llmContent.length
            : undefined);
    });
